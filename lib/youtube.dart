...
class YouTubeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('YouTube Exercises'),
      ),
      // Wrapped in SizedBox.expand and DecoratedBox for full-screen background
      body: SizedBox.expand(
        child: DecoratedBox(
          decoration: const BoxDecoration(
            color: Colors.white,
            image: DecorationImage(
              image: AssetImage("assets/chatbg7.jpg"), // Consistent with your other screens
              fit: BoxFit.cover,
            ),
          ),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.blueAccent.withOpacity(0.8), // Added slight opacity
